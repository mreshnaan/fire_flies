...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 items-center justify-between py-2 lg:py-4 font-medium transition-all group text-[#13AFB6] ',
        className
      )}
      {...props}
    >
      {children}
      <div className='h-[22px] w-[22px] lg:h-[38px] lg:w-[38px] flex items-center justify-center border border-[#13AFB6]'>
